...
RABBIRMQ_EXCHANGE_ERROR = config.load(
    'RABBIRMQ_EXCHANGE_ERROR', 'bus', 'error_exchange')
...
DEFAULT_TEMPLATE_TEXT = config.load(
    'DEFAULT_TEMPLATE_TEXT',
    'default_template',
    'text')
DEFAULT_TEMPLATE_SUBJECT = config.load(
